...
public class Searchtest extends Basetest {
    ...
    public void searchNonExistingProduct() {
		driver.findElement(By.xpath("//div[@id='nav-search-dropdown-card']"));
		 Select dropdo = new Select(driver.findElement(By.cssSelector("select[aria-describedby='searchDropdownDescription']")));
	    dropdo.selectByVisibleText("Amazon Devices");
	...
	public void searchExistingProduct() {
	    ...
	    driver.findElement(By.id("nav-search-submit-button")).click();
	    boolean isProductDisplayed = driver.findElements(By.xpath("//*[@id=\"search\"]/div[1]/div[1]/div/span[1]/div[1]/div[6]")).size() > 0;
	...
	public void addProductToCart() throws InterruptedException {
	    ...
	    String cartText = driver.findElement(By.xpath("//div[@class='a-row puis-atcb-remove-group']/span[1]")).getText();
	...
	public void updateQuantityInCart() throws InterruptedException {
	    ...
	    WebElement dropdownElement = driver.findElement(By.xpath("//select[@class='a-native-dropdown a-declarative sc-update-quantity-select']"));
